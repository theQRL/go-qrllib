...
fuzz-mlkem:
	@echo "Fuzzing ML-KEM-1024 ($(FUZZ_TIME) per target)..."
	@go test -fuzz=FuzzMLKEM1024NewEncapsulationKey -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
	@go test -fuzz=FuzzMLKEM1024NewDecapsulationKey -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
	@go test -fuzz=FuzzMLKEM1024Decapsulate -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
	@go test -fuzz=FuzzMLKEM1024RoundTripMutate -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
	@go test -fuzz=FuzzMLKEM1024MetamorphicWrongKey -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
	@go test -fuzz=FuzzMLKEM1024MetamorphicDecapsDeterminism -fuzztime=$(FUZZ_TIME) ./crypto/internal/mlkem1024/...
